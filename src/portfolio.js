...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("🌐 Web 3.0: Solidity, Smart Contracts"),
    emoji(
      "📋 Project Management & Development Workflow: Agile, Scrum, Git, GitHub, Vercel, ServiceNow, Jira, Confluence"
    ),
    emoji("🎨 UI Design & Web Accessibility: Figma, Sketch, Mobile-First Design, WCAG, ARIA"),
    emoji("🔗 Web Services & API: RESTful APIs, Custom API Endpoints"),
    emoji(
      "⚡ SEO & Performance: On-Page SEO, Technical SEO, Google Analytics, Lighthouse, Performance Audits, Page Speed Optimization"
    ),
    emoji("📊 Data Visualization: D3.js, Chart.js, Highcharts"),
  ],
};
...
const techStack = {
  ...
  experience: [
    ...
    {
      Stack: "HTML", //Insert stack or technology you have experience
      progressPercentage: "85%", //Insert relative proficiency in percentage
    },
    {
      Stack: "React",
...
const achievementSection = {
  ...
  achievementsCards: [
    ...
    },
    {
      ...
      subtitle: "United States Army Veteran | Honorably Served Four Years",
      // image: require("./assets/images/OAST-TT-Logo.jpg"),
      // imageAlt:
      //   "DHS Office of Accessible Systems & Technology | Section 508 Trusted Tester Certification",
    },
